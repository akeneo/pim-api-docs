...
::: warning
The connection described in this guide is based on our brand new way to manage the assets: the **Asset Manager**. This feature was introduced in the 3.2 version.  
...
First, photographers or marketers upload their new product assets into the DAM. Then, thanks to the connector we're going to build in this guide, those assets are sent via the API to the Asset Manager of our PIM.  

Once the assets are inside the Asset Manager, there are two ways to link them to the right product:
...
4. For this step, you are going to choose your connector architecture and technical stack. Check out this [section](technical-stack.html) to learn more. You'll see it also provides you with pro tips regarding the scalability or the errors handling and so on...
5. Now, hands on your keyboard, that's the part where you are going to start coding. Build the DAM-PIM connector by following the steps described in the [Synchronize assets](synchronize-assets.html) section.

And... that's it! :tada: You now have a functional DAM-PIM connector.

::: info
Don't forget that this guide isn't meant to be exhaustive. You'll find millions of ways to improve this first DAM-PIM connector version. Don't hesitate to iterate to support new use cases, it's the key to great connectors!
:::
...
::: warning
This connector skeleton is provided as it is. It is only supported in **best effort**, whether you are an Enterprise or Community customer.
:::

::: warning
This skeleton is **far from being production-ready**. We don't recommend you use it as it is. Its sole purpose is for training and learning.
:::

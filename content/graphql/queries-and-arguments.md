...
| `attributesToLoad` | **String[]** | Restrict the attribute values we will load on the product, more details on [Best practices](/graphql/best-practices.html#load-only-required-product-attributes)                       |

...
### Why am I not receiving events immediately after creating a subscription?

When you create a new subscription, there is a synchronization delay of several minutes before it becomes fully active. This delay is due to the propagation time between the subscription management service and the event delivery service. We recommend waiting a few minutes after subscription creation before expecting to receive events.

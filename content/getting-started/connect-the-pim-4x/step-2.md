...
::: tips
For SaaS users, you can also go to `Connect` from your Akeneo PIM, then click on `Akeneo App Store`, and access the Akeneo App Store directly from the link `Here you go`. You will access a filtered list of all the extensions compatible with your PIM edition. 
:::

...
Deleting a family was juts possible in the UI and we added an endpoint to allow for API deletion.
This will also allow you to mass delete family with a script if needed.

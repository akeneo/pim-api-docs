...
Great news for developers: our official GraphQL API is now live and ready for you to integrate into your projects! 
Experience seamless data querying, real-time updates, and a more intuitive way to interact with your PIM.
Don't wait, and give it a try by visiting the documentation in the top menu (menu API resources).

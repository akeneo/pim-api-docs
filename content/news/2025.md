...
To enhance developer experience, we've added a new property to the [Asset GET routes](/api-reference.html#get_assets): You will now find the `attribute_type` property, which indicates the attribute type for each asset value.  
...
### <span class="label label-news label-added">ADDED</span> Asset Auto-tagging attribute
...
Check the related [release note](https://help.akeneo.com/2025/october-2025-serenity-updates) and the [API documentation](/concepts/asset-manager.html#the-auto_tagging-attribute).

...
## Message `com.akeneo.pim.v1.app.deleted`
...
| 0 (allOf item) | object | CloudEvents Specification JSON Schema | - | - | **additional properties are allowed** |
| id | string | - | - | non-empty | **required** |
| source | string | - | - | format (`uri-reference`), non-empty | **required** |
| specversion | string | - | - | non-empty | **required** |
| type | string | - | - | non-empty | **required** |
| datacontenttype | string \| null | - | - | non-empty | - |
| dataschema | string \| null | - | - | format (`uri`), non-empty | - |
| subject | string \| null | - | - | non-empty | - |
| time | string \| null | - | - | format (`date-time`), non-empty | - |
| data | object \| string \| number \| array&lt;any&gt; \| boolean \| null | - | - | - | **additional properties are allowed** |
| data_base64 | string \| null | - | - | encoding (`base64`) | - |

> Examples of payload

_com.akeneo.pim.v1.app.deleted_
...
## Message `com.akeneo.pim.v1.attribute.deleted`
...
_com.akeneo.pim.v1.attribute.deleted_
...
## Message `com.akeneo.pim.v1.attribute.updated`
...
This event is generated whenever an existing attribute is modified in the PIM. The modifications that can lead to this event include changes to the following properties:
...
_com.akeneo.pim.v1.attribute.updated_
...
## Message `com.akeneo.pim.v1.attribute-group.updated`
...
_com.akeneo.pim.v1.attribute-group.updated_
...
## Message `com.akeneo.pim.v1.attribute-group.deleted`
...
_com.akeneo.pim.v1.attribute-group.deleted_
...
## Message `com.akeneo.pim.v1.product.created`
...
This event is triggered whenever a new product is created in the PIM. The following actions can trigger a product creation event:
...
_com.akeneo.pim.v1.product.created_
...
## Message `com.akeneo.pim.v1.product.updated`
...
This event is triggered whenever an existing product is modified in the PIM. The following actions can trigger a product update event:
...
_com.akeneo.pim.v1.product.updated_
...
## Message `com.akeneo.pim.v1.product.deleted`
...
This event is triggered whenever a product is removed from the PIM. The following actions can trigger a product deletion event:
...
_com.akeneo.pim.v1.product.deleted_
...
## Message `com.akeneo.pim.v1.product-model.deleted`
...
_com.akeneo.pim.v1.product-model.deleted_
...
## Message `com.akeneo.pim.v1.product-model.created`
...
_com.akeneo.pim.v1.product-model.created_
...
## Message `com.akeneo.pim.v1.product-model.updated`
...
_com.akeneo.pim.v1.product-model.updated_
...
## Message `com.akeneo.pim.v1.connection.deleted`
...
_com.akeneo.pim.v1.connection.deleted_
...
## Message `com.akeneo.pim.v1.category.created`
...
_com.akeneo.pim.v1.category.created_
...
## Message `com.akeneo.pim.v1.category.updated`
...
_com.akeneo.pim.v1.category.updated_
...
## Message `com.akeneo.pim.v1.category.deleted`
...
_com.akeneo.pim.v1.category.deleted_
...
## Message `com.akeneo.pim.v1.asset.created`
...
_com.akeneo.pim.v1.asset.created_
...
## Message `com.akeneo.pim.v1.asset.updated`
...
_com.akeneo.pim.v1.asset.updated_
...
## Message `com.akeneo.pim.v1.asset.deleted`
...
_com.akeneo.pim.v1.asset.deleted_
...
## Message `com.akeneo.pim.v1.family.updated`
...
_com.akeneo.pim.v1.family.updated_
...
## Message `com.akeneo.pim.v1.family.deleted`
...
_com.akeneo.pim.v1.family.deleted_
...
## Message `com.akeneo.pim.v1.reference-entity-record.updated`
...
_com.akeneo.pim.v1.reference-entity-record.updated_
...
## Message `com.akeneo.pim.v1.attribute-option.deleted`
...
_com.akeneo.pim.v1.attribute-option.deleted_
...
## Message `com.akeneo.pim.v1.attribute-option.updated`
...
_com.akeneo.pim.v1.attribute-option.updated_

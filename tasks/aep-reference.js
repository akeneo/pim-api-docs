...
gulp.task('build-aep-reference-page', ['clean-dist', 'less'], function() {
    ...
    _.forEach(versions, function(version) {
        ...
        var htmlReferencefileName = (version === '1.7') ? 'akeneo-event-platform/api-reference-17' :
                                    (version === '2.0') ? 'akeneo-event-platform/api-reference-20' :
                                    (version === '2.1') ? 'akeneo-event-platform/api-reference-21' :
                                    (version === '2.2') ? 'akeneo-event-platform/api-reference-22' :
                                    (version === '2.3') ? 'akeneo-event-platform/api-reference-23' :
                                    (version === '3.0') ? 'akeneo-event-platform/api-reference-30' :
                                    (version === '3.1') ? 'akeneo-event-platform/api-reference-31' :
                                    (version === '3.2') ? 'akeneo-event-platform/api-reference-32' :
                                    (version === '4.0') ? 'akeneo-event-platform/api-reference-40' :
                                    (version === '5.0') ? 'akeneo-event-platform/api-reference-50' :
                                    (version === '6.0') ? 'akeneo-event-platform/api-reference-60' :
                                    (version === '7.0') ? 'akeneo-event-platform/api-reference-70' : 'akeneo-event-platform/api-reference';

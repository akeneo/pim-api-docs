...
gulp.task('reference-paas', ['clean-dist', 'less'], function() {
    ...
    _.forEach(versions, function(version) {
        ...
        var htmlReferenceIndexfileName = (version === '1.7') ? 'api-reference-paas-index-17' :
                                        (version === '2.0') ? 'api-reference-paas-index-20' :
                                        (version === '2.1') ? 'api-reference-paas-index-21' :
                                        (version === '2.2') ? 'api-reference-paas-index-22' :
                                        (version === '2.3') ? 'api-reference-paas-index-23' :
                                        (version === '3.0') ? 'api-reference-paas-index-30' :
                                        (version === '3.1') ? 'api-reference-paas-index-31' :
                                        (version === '3.2') ? 'api-reference-paas-index-32' :
                                        (version === '4.0') ? 'api-reference-paas-index-40' :
                                        (version === '5.0') ? 'api-reference-paas-index-50' :
                                        (version === '6.0') ? 'api-reference-paas-index-60' :
                                        (version === '7.0') ? 'api-reference-paas-index-70' : 'api-reference-paas-index';
        var htmlReferencefileName = (version === '1.7') ? 'api-reference-paas-17' :
                                    (version === '2.0') ? 'api-reference-paas-20' :
                                    (version === '2.1') ? 'api-reference-paas-21' :
                                    (version === '2.2') ? 'api-reference-paas-22' :
                                    (version === '2.3') ? 'api-reference-paas-23' :
                                    (version === '3.0') ? 'api-reference-paas-30' :
                                    (version === '3.1') ? 'api-reference-paas-31' :
                                    (version === '3.2') ? 'api-reference-paas-32' :
                                    (version === '4.0') ? 'api-reference-paas-40' :
                                    (version === '5.0') ? 'api-reference-paas-50' :
                                    (version === '6.0') ? 'api-reference-paas-60' :
                                    (version === '7.0') ? 'api-reference-paas-70' : 'api-reference-paas';
        ...
        gulp.src('./content/swagger/akeneo-web-api.yaml')
            ...
            .pipe(jsonTransform(function(data, file) {
                ...
                return gulp.src('src/api-reference-paas/index.handlebars')
        ...
        gulp.src('content/swagger/akeneo-web-api.yaml')
            ...
            .pipe(jsonTransform(async function(data) {
                ...
                return gulp.src('src/api-reference-paas/reference.handlebars')
                    .pipe(gulpHandlebars(templateData, {}))
